    ...
    var action = {
        ...
        touch: function () {
            current.canvas.onclick = function () {
                modules.render(prop.content.touch || ["呐，你想变成什么颜色？","如果是这样的话，那就从我的心中滚出去。","因为有以后，所以才有趣。", "如果因为害怕失败，而不去努力，那就不会有能够成功的人。", "要抹去懊悔，终究只有继续不断努力。","相似的日常，会感到无聊。但是，在夏天捡到了一只白色的猫，来到了樱花庄，我发现了 无聊的并不是这段时光，而是和别人相似的自己。"]);
            };
        },
        // 右侧按钮
        buttons: function () {
